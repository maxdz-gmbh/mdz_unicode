...
#ifndef MDZ_UNICODE_WCHAR_H
#define MDZ_UNICODE_WCHAR_H

#include "mdz_types.h"

/**
 * Handle of "wide"-character string in mdz_unicode library
 */
struct mdz_Wchar
{
  /**
 ...
 * mdz_true  - insertion succeeded
 */
mdz_bool mdz_wchar_insertAnsi_string_async(struct mdz_Wchar* pWchar, size_t nLeftPos, const void* pAnsiSource, mdz_bool bReserve, struct mdz_asyncData* pAsyncData);
 ...
 * mdz_true  - insertion succeeded
 */
mdz_bool mdz_wchar_insertUtf8_string_async(struct mdz_Wchar* pWchar, size_t nLeftPos, const void* pUtf8Source, mdz_bool bReserve, struct mdz_asyncData* pAsyncData);
 ...
 * mdz_true  - insertion succeeded
 */
mdz_bool mdz_wchar_insertUtf16_string_async(struct mdz_Wchar* pWchar, size_t nLeftPos, const void* pUtf16Source, mdz_bool bReserve, struct mdz_asyncData* pAsyncData);
 ...
 * mdz_true  - insertion succeeded
 */
mdz_bool mdz_wchar_insertUtf32_string_async(struct mdz_Wchar* pWchar, size_t nLeftPos, const void* pUtf32Source, mdz_bool bReserve, struct mdz_asyncData* pAsyncData);
