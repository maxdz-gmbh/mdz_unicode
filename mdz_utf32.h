...
#ifndef MDZ_STRING_UTF32_H
#define MDZ_STRING_UTF32_H
 ...
 * mdz_true  - insertion succeeded
 */
mdz_bool mdz_utf32_insertWchar_async(struct mdz_Utf32* pUtf32, size_t nLeftPos, const wchar_t* pwcItems, size_t nCount, mdz_bool bReserve, struct mdz_asyncData* pAsyncData);

/**
 * Synchronous version
 */
#define mdz_utf32_insertWchar(pUtf32, nLeftPos, pwcItems, nCount, bReserve) mdz_utf32_insertWchar_async(pUtf32, nLeftPos, pwcItems, nCount, bReserve, NULL)
